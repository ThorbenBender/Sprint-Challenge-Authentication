...
1. What is the purpose of using _sessions_? Session is a simple way to store data from users
1. What does bcrypt do to help us store passwords in a secure manner. it hashes the password so it won't get found out that easily
1. What does bcrypt do to slow down attackers? The incoporate salt to protect against rainbow tables
1. What are the three parts of the JSON Web Token? The three parts of the json web token are header, payload and the signature
